...
//     private geometryLine: THREE.BufferGeometry;
...
//         this.geometryPoints.push(stackHelper.slice.planePosition.clone());
//         this.geometryPoints.push(endPosition);
//         this.geometryLine = new THREE.BufferGeometry().setFromPoints( this.geometryPoints );

//         // THREE.BufferGeometry.attributes.position.needsUpdate = true;
...
//     updateWidget() {
//         // update line
//         this.geometryLine.setFromPoints[0] = this.stackHelper.slice.planePosition.clone();
...
//         this.geometryLine.setFromPoints[1] = endPosition;
