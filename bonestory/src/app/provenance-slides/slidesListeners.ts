...
export const addListenersSlides = (slideDeck: SlideDeckVisualization, deck: ProvenanceSlidedeck, service: ProvenanceService) => {
    ...
    // let exportButton = document.getElementById("slidesExportButton");
    ...
    //     slideDeck.setDeck(deck.restoreSelf(data_in, service.traverser, service.graph, service.graph.application));
    //     slideDeck.update();
    // }
